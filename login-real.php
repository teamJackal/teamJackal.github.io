...
if(isset($_POST['Submit'])) {
    ...
    while($res = $sel->fetch(PDO::FETCH_ASSOC)){
        ...
        echo "<script type='text/javascript'>  window.location='MainCategoryReal.php?id=".$id."'; </script>";
    }
}
...
<body style="background-color: #EAABAB;">
...
<div class="container">
  <h1 class="text-center">Real System Login</h1>
</div>

<div id="body" class="container center">
  <div class="thumbnail text-center">
    <form action="login-real.php" method="POST">
